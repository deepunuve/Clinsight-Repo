...
import { fetchPubmedResult } from '../../api/source';
...
const Pubmed = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetchPubmedResult(condition);
                            ...
                            {currentItemsToShow.map((_item, index) => (
                                <Col key={_item.id} xs={12} md={12}>
                                    <Card className="mb-3 shadow-sm rounded border">
                                        <Card.Body>
                                            {/* Title & ID */}
                                            <a variant="link" className="d-flex align-items-center mb-2 text-decoration-none">
                                            ...
                                            <Card.Text>{_item.Abstract}</Card.Text>
                                            ...
                                            <Card.Text>{_item.Authors.join(', ')}</Card.Text>
