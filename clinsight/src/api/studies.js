...
export const fetchStudies = async () => {
  try {
    ...
    const response = await axios.get('http://184.105.215.253:9003/studylist_nl/');
...
export const fetchStudyDetails = async (payload) => {
  try {
    ...
    const response = await axios.post('http://184.105.215.253:9003/study_details_nl', payload, {
      headers: {
